...
class ChartWrapper extends React.Component { 
    ...
    chartTypeDropDownOptions(){
        let options = this.state.chartTypes.map((type) => (
        ...
        switch(this.state.currentChartType){
            ...
            case("Area"):
                return(
                    ...
                    traceLabels={this.props.traceLabels}
                    graphHeight={this.state.graphHeight}
                    graphWidth={this.state.graphWidth}></RenderAreaChart>
                )
            case("Bar"):
                return(
                    <RenderBarChart
                    ...
                    traceLabels={this.props.traceLabels}
                    graphHeight={this.state.graphHeight}
                    graphWidth={this.state.graphWidth}></RenderBarChart>
                )
            case("Scatter"):
                return(
                    <RenderScatterChart
                    ...
                    traceLabels={this.props.traceLabels}
                    graphHeight={this.state.graphHeight}
                    graphWidth={this.state.graphWidth}></RenderScatterChart>
                )
            case("Composed"):
                return(<RenderComposedChart
                    ...
                    graphHeight={this.state.graphHeight}
                    graphWidth={this.state.graphWidth}
                    composedLines={this.props.composedLines}></RenderComposedChart>
                )
            default:
                return(
                    <h3>No chart type selected somehow</h3>
                )
        }
    }
