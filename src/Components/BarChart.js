...
class RenderBarChart extends React.Component{
    constructor(props){
        super(props);
        this.state = {
            chartTile : '',
        ...
        return(
                <div className="ChartRender">
                    ...
                    <div className="downloadTarget" id="LineChartTarget">
                        <BarChart width={this.props.graphWidth} height={this.props.graphHeight} data={this.props.data} margin={{ top: 5, right: 20, bottom: 5, left: 0 }}>
